...
Notas:
- Se os dados estiverem a ser escritos para algum ficheiro e se o programa for abortado (aparece no final "Aborted"), significa que ocorreu o erro mencionado no parágrafo acima.
- Na ocorrência deste erro, alguns fifos criados podem não ser destruidos. 
